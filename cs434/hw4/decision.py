...
for m in range(M):
  ...
  randomIntegers = rng.integers(0, size, size)

  X_data = X_train[randomIntegers]
  y_data = y_train[randomIntegers]


  #Fit the model and store it's predictions
  clf = tree.DecisionTreeClassifier(criterion="entropy", max_features=20)
