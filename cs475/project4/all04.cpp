...
/*
    fprintf( stdout, "%12s\tN %12s\tS %12s\t(%8s)\tN %12s\tS %12s\t(%8s)\t\n",
...
*/
	...
	fprintf( stdout, "N,%10.2lf\t,", megaMults );
	...
	fprintf( stdout, "S,%10.2lf\t,", megaMults );
	...
	fprintf( stdout, "N,%10.2lf\t,", megaMultAdds );
	mmn = megaMultAdds;
